        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" href="javascript:;">카테고리댓글</a>
                </div>
...
<script type="text/javascript">
    ...
    function goto_url(board_title, cmt_idx) {
        window.open('https://freshrimpsushi.github.io/categories/' + board_title + '#comment' + cmt_idx, '_blank');
    }
        ...
        $.messager.confirm({
            ...
            fn: function(r) {
                if (r) {
                    $.ajax({
                        type: "POST",
                        url: "<?php echo AJAX_URL; ?>/ajax.categories.php?action=deleteComment",
                        data: {
                            cmt_idx: cmt_idx
                        },
                        dataType: "json",
        ...
        $.messager.confirm({
            ...
            fn: function(r) {
                if (r) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo AJAX_URL; ?>/ajax.categories.php?action=modifyComment",
                        data: {
                            cmt_idx: cmt_idx,
                            content: content
                        },
    ...
    function re_comment_click(cmt_idx) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo AJAX_URL; ?>/ajax.categories.php?action=writeReComment",
            data: {
                cmt_idx: cmt_idx,
                admin_id: admin_id,
                content: content
    ...
    $(document).ready(function() {
        $.ajax({
            type: "POST",
            url: "<?php echo AJAX_URL; ?>/ajax.categories.php?action=getComment",
            data: {},
            dataType: "json",
            success: function(data) {
                let msg = data['msg'];
