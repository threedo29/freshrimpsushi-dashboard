        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" href="javascript:;">404페이지댓글</a>
                </div>
...
<script type="text/javascript">
        ...
        $.messager.confirm({
            ...
            fn: function(r) {
                if (r) {
                    $.ajax({
                        type: "POST",
                        url: "<?php echo AJAX_URL; ?>/ajax.404page.php?action=deleteComment",
                        data: {
                            cmt_idx: cmt_idx
                        },
                        dataType: "json",
        ...
        $.messager.confirm({
            ...
            fn: function(r) {
                if (r) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo AJAX_URL; ?>/ajax.404page.php?action=modifyComment",
                        data: {
                            cmt_idx: cmt_idx,
                            content: content
                        },
    ...
    function re_comment_click(cmt_idx) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo AJAX_URL; ?>/ajax.404page.php?action=writeReComment",
            data: {
                cmt_idx: cmt_idx,
                admin_id: admin_id,
                content: content
    ...
    $(document).ready(function() {
        $.ajax({
            type: "POST",
            url: "<?php echo AJAX_URL; ?>/ajax.404page.php?action=getComment",
            data: {},
            dataType: "json",
            success: function(data) {
                let msg = data['msg'];
